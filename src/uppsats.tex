...
Även här är bilderna 224x244. VGGNet kom efter Alexnet och är väldigt kraftfullt men väldigt stort \parencite{simonyan2014very}. De använde sig även av data augmentation och dropout för att minska overfitting. 
